...
1. On the **Everything** blade, in the search results, click **Windows Server**. _HINT: if this option is not avaiable you can select "Windows Server 2016 Datacenter" from the list of popular options_
